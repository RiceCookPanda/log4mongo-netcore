...
namespace Log4Mongo
{
    public class MongoDBAppender : AppenderSkeleton
    {
        ...
        private IMongoCollection<BsonDocument> GetCollection()
        {
            ...
            if (CollectionName.Equals("yyyyMM"))
            {
                collectionName = "logs" + DateTime.Now.ToString("yyyyMM");
            }
            else if (CollectionName.Equals("yyyyMMdd"))
            {
                collectionName = "logs" + DateTime.Now.ToString("yyyyMMdd");
            }
            else if (CollectionName.Equals("yyyy"))
            {
                collectionName = "logs" + DateTime.Now.ToString("yyyy");
            }
        ...
        private void CreateExpiryAfterIndex(IMongoCollection<BsonDocument> collection)
        {
            ...
            collection.Indexes.CreateOneAsync(new CreateIndexModel<BsonDocument>(Builders<BsonDocument>.IndexKeys.Ascending("timestamp"), new CreateIndexOptions
            {
